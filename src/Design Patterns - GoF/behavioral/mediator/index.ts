...
Define um objeto que encapsula como um conjunto de objetos interage. O mediator promove o acoplamento fraco ao evitar
que os objetos se refiram explicitamente uns aos outros, permitindo que você varie suas interações

Sobre o Mediadator

. Visa encapsular a comunicação direta entre objetos
. Desacopla objetos que estariam intimamente ligados
. Centraliza toda comunicação em apenas um objeto
...
. É facil criar um mediator "faz tudo" (god class)
